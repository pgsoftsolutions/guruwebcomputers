        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <ul class="unstyled address">
                    <li>
                        <i class="icon-home"></i><strong>Address:</strong> GURU COMPUTERS<br>MUCHH KI PIPLI, GONER ROAD, JAIPUR
                    </li>
                    <li>
                        <i class="icon-envelope"></i>
                        <strong>Email 1: </strong> gurucomputero07@gmail.com
                    </li>
					<li>
                        <i class="icon-envelope"></i>
                        <strong>Email 2: </strong> Nandusahu7@gamail.com
                    </li>
                    <li>
                        <i class="icon-globe"></i>
                        <strong>Website:</strong> www.gurucomputersweb.com
                    </li>
                    <li>
                        <i class="icon-phone"></i>
                        <strong>Phone 1:</strong> 9529221785
                    </li>
					<li>
                        <i class="icon-phone"></i>
                        <strong>Phone 2:</strong> 9529422929
                    </li>
                </ul>
            </div>
            <!--End Contact Form-->
